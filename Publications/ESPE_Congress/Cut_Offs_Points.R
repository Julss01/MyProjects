...
setwd("C:/Users/julil/Desktop/Pruebas/ESPE/")
genobox_raw <- read.csv("C:/Users/julil/Desktop/Pruebas/ESPE/2024_05_07_genobox_espe_congress.csv", sep= ";", header = T)
g <- read.csv("C:/Users/julil/Desktop/Pruebas/ESPE/2024_05_13_genobox_seep_congreso.csv", sep= ";", header = T)
g <- na.omit(g)
genobox_raw <- na.omit(genobox_raw)
genobox <- merge(genobox_raw, g, by= "code")
iberomics_raw <- read.csv("C:/Users/julil/Desktop/Pruebas/ESPE/2024_05_07_iberomics_espe_congress.csv", sep= ";", header = T)
iberomics_raw <- na.omit(iberomics_raw)
i <- read.csv("C:/Users/julil/Desktop/Pruebas/ESPE/2024_05_13_iberomics_seep_congreso.csv", sep= ";", header= T)
i <- na.omit(i)
